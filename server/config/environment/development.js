...
module.exports = {
    ...
    aws: {
        s3: {
            awsAccessKeyId: 'AKIAJIM3KDZUMGMNAYEA' || 'AWS_ACCESS_KEY_ID',
            awsSecretAccessKey: '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' || 'AWS_SECRET_ACCESS_KEY',
            bucket: 'simple-yacht-jobs-test' || 'AWS_S3_BUCKET'
        }
    }
};